        ...
        <div className="p-8" ref={factureRef}>
          <div className="flex justify-between items-center text-sm">
            <div className="flex flex-col">
              ...
              <h1 className="text-7xl font-bold uppercase">Invoice</h1>
            </div>
            <div className="text-right uppercase">
              <p className="badge badge-ghost ">Invoice ° {invoice.id}</p>
              <p className="my-2">
                <strong>Date </strong>
          ...
          <div className="my-6 flex justify-between">
            <div>
              <p className="badge badge-ghost mb-2">Issuer</p>
          ...
          <div className="mt-6 space-y-2 text-md">
            ...
            <div className="flex justify-between">
              <div className="font-bold">Total (Incl. VAT)</div>
